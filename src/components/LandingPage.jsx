    ...
    <div className="min-h-[calc(100vh-64px)]  lg:px-14 sm:px-8 px-4">
      <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
        <div className=" flex-1">
          ...
          >
            Redirectly Simplifies URL Shortening For Efficient Sharing.
          </motion.h1>
          <p className="text-slate-700 text-sm my-5">
            Redirectly streamlines the process of URL shortening, making sharing
            links effortless and efficient. With its user-friendly interface,
            Redirectly allows you to generate concise, easy-to-share URLs in
            seconds. Simplify your sharing experience with Redirectly today.
          </p>
        ...
        <div className="   flex-1 flex   justify-center w-full">
          <motion.img
            ...
            src="/images/rocket-icon-vector.png"
            alt="Rocket image"
          />
        </div>
      </div>
